<template>
    <div class="rounded-lg p-8 mb-8"
        ...
        <h2 class="text-2xl font-semibold text-[var(--text-primary)] mb-6">Laning Phase</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex justify-between items-center">
                        <h3 class="text-xl font-bold text-[var(--text-primary)]">CS @ 10 mins</h3>
                ...
                <div class="px-3 py-0">
                    <div class="space-y-2">
                        <div class="flex justify-between items-center py-2 border-b border-[var(--card-background)]/30">
                            <span class="text-[var(--text-secondary)] font-medium">Your CS</span>
                            <span class="text-[var(--text-primary)] font-bold text-lg">{{
                                csComparison.playerValue.toFixed(1) }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b border-[var(--card-background)]/30">
                            <span class="text-[var(--text-secondary)] font-medium">Average CS</span>
                            <span class="text-[var(--text-primary)] font-bold text-lg">{{
            ...
            <div
                ...
                <div
                    class="bg-gradient-to-r from-[var(--primary-color)]/20 to-[var(--primary-color)]/10 p-3 border-b border-[var(--card-background)]/50">
                    <div class="flex justify-between items-center">
                        <h3 class="text-xl font-bold text-[var(--text-primary)]">Denies @ 10 mins</h3>
                ...
                <div class="px-3 py-0">
                    <div class="space-y-2">
                        <div class="flex justify-between items-center py-2 border-b border-[var(--card-background)]/30">
                            <span class="text-[var(--text-secondary)] font-medium">Your Denies</span>
                            <span class="text-[var(--text-primary)] font-bold text-lg">{{
                                deniesComparison.playerValue.toFixed(1) }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b border-[var(--card-background)]/30">
                            <span class="text-[var(--text-secondary)] font-medium">Average Denies</span>
                            <span class="text-[var(--text-primary)] font-bold text-lg">{{
